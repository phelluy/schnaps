...
ZMIN = 0;
ZMAX = 1;
Point(1) = {XMIN, YMIN, ZMIN, raf};
Point(2) = {XMAX, YMIN, ZMIN, raf};
Point(3) = {XMAX, YMAX, ZMIN, raf};
Point(4) = {XMIN, YMAX, ZMIN, raf};
Point(5) = {XMIN, YMIN, ZMAX, raf};
Point(6) = {XMAX, YMIN, ZMAX, raf};
Point(7) = {XMAX, YMAX, ZMAX, raf};
Point(8) = {XMIN, YMAX, ZMAX, raf};
Line(1) = {1, 2};
...
Line(9) = {2, 6};
Transfinite Line {9} = raf3+1 Using Progression 1;
Line(10) = {3, 7};
Transfinite Line {10} = raf3+1 Using Progression 1;
Line(11) = {4, 8};
Transfinite Line {11} = raf3+1 Using Progression 1;
Line(12) = {1, 5};
Transfinite Line {12} = raf3+1 Using Progression 1;
