...
Line(9) = {2, 6};
Transfinite Line {9} = rafz Using Progression 1;
Line(10) = {3, 7};
Transfinite Line {10} = rafz Using Progression 1;
Line(11) = {4, 8};
Transfinite Line {11} = rafz Using Progression 1;
Line(12) = {1, 5};
Transfinite Line {12} = rafz Using Progression 1;
